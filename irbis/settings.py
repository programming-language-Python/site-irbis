"""
Django settings for irbis project.
...
ALLOWED_HOSTS = ['site-irbis.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'irbis.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'irbis/static'),
]
